...
- **Git:** tree clean — Phase 9 + 10.1–10.6 committed + pushed 2026-08-21 (since `667364f`; 10.5 = `af6cd5d`, 10.6 = `c326004`). Pages auto-deploys from main within a few minutes. Commit only if the user asks (AGENTS rule 7).
