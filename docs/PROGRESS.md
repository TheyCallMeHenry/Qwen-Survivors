...
- **Git:** tree clean — 10.7 + 10.8 committed + pushed 2026-08-21 (10.7/10.8 = `26a24b0`). Pages auto-deploys from main within a few minutes. Commit only if the user asks (AGENTS rule 7).
