...
- **Git:** tree clean — Phase 14 spec docs committed + pushed 2026-08-21 (Phase 14 spec = `aa9c3ba`). Pages auto-deploys from main within a few minutes. Commit only if the user asks (AGENTS rule 7).
