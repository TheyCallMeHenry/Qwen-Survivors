...
- **Git:** tree clean — 13.1 level framework committed + pushed 2026-08-21 (13.1 = `26032b2`). Pages auto-deploys from main within a few minutes. Commit only if the user asks (AGENTS rule 7).
