...
- **Phase 22 — playtest defects round 2 (user report 2026-08-28, queued before 12.3):** weapon sprite/damage visibility audit (garlic + aegis blades reported invisible in the published build), XP gems dropped in non-traversable spots (ice-pond middle etc.) pushed out to the spot's edge, and M03 gem/heart color-contrast fix. Tasks: `docs/PROGRESS.md` (Phase 22).
